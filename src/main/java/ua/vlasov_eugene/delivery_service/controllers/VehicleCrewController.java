...
public class VehicleCrewController {
	...
	public Page<VehicleCrew> getCrewsByFilter(@ApiParam(value = "Статус, говорящий о состоянии экипажа\n" +
	...
	@PostMapping("/new")
	public VehicleCrew createNewCrew (@RequestBody List<String> couriersCode){
		return crewService.createNewCrew(couriersCode);
	}

	@ApiOperation("Возвращает экипаж по id")
	@GetMapping("/{id}")
	public VehicleCrew getCrewById(@PathVariable Long id){
	...
	@PutMapping
	public OldAndNewVersionCrewDto updateCrew(@RequestBody VehicleCrew oldVersionOfCrew){
